 ...
 * @author jabaraster
 */
public class PrimitiveBooleanEditor extends Panel {
     ...
     * @param pModel -
     */
    public PrimitiveBooleanEditor(final String pId, final BeanProperty pProperty, final IModel<Boolean> pModel) {
        super(pId, pModel);
